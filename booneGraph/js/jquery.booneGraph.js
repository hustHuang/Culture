    ...
    $.extend($.fn, {
        ...
        */
        booneGraph : function(o) {
            /* Default options */
            var DEFAULTS = {
                defaultNodeColor: '#00EC00',//default color set not here
                maxSliderVal: 1000,
                runningLayout: null,
                layouts: [],
                annotations: [],
                ...
                $(rootElement).append(
                    ...
                    $('<div id="selection-menu-container" class="draggable menu-container" style="display: none;">').append(
                        $('<ul class="menu">').append(
                            ...
                            $('<li><a href="#" id="menu-isolate-nodes">Isolate selected nodes</a></li><li><a href="#" id="menu-getfile-nodes">Get file lists</a></li>')
                        ))
                    ).append(
            ...
            function init() {
                ...
                // }).hoverHighlight(_
                    ...
                    'dblclicknodes', onNodesClick).bind('downnodes', onNodesCtrlClick);
